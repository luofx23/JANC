...
from ..solver_1D import rhs,time_step,aux_func as rhs_1D,time_step_1D,aux_func_1D
from ..solver_2D import rhs,time_step,aux_func as rhs_2D,time_step_2D,aux_func_2D
from ..solver_3D import rhs,time_step,aux_func as rhs_3D,time_step_3D,aux_func_3D
